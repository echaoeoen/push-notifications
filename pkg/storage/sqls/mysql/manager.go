...
import (
	...
	_ "github.com/oeoen/push-notifications/pkg/storage/sqls/mysql/migrations"
...
func (m *MYSQLManager) Open() error {
	...
	if err != nil {
		return errorp.DBConnectionError(err.Error())
	}
	m.db = db
...
func (m *MYSQLManager) Prepare(query string) (*sql.Stmt, error) {
	...
	if !ok {
		...
		if err != nil {
			return nil, errorp.NewNotificationError(500, "err_stmt_db", "Please check your database load", err.Error())
		}
